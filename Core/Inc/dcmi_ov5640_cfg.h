...
// 手册里没有说明这些寄存器的作用,这里直接保留手册给的设置参数  
	{0x3630,0x36},	{0x3631,0x0e},	{0x3632,0xe2},	{0x3633,0x12},	{0x3621,0xe0},	{0x3704,0xa0},	
...
// 除了要设置接口的输出格式，ISP（image sensor processor）图像处理单元也要设置成对应的格式	
   ...
   {0x3820, 0x47}, 	// Bit[2:1]用于设置是否垂直翻转，其余位的作用手册里没有说明
	 //{0x3820, 0xF9}, 	// Bit[2:1]用于设置是否垂直翻转，其余位的作用手册里没有说明
...
// 不清楚要如何去配置，这里直接使用 OV5640应用指南 里的设置
	...
	//{0x3a00,0x0c},  //夜间模式 位1为1      位1为0 禁止
	//{0x3a05,0x40},  //Bit[6]: frame insert 0: In night mode, insert frame disable 1: In night mode, insert frame enable
// 曝光时间相关  
// 不清楚要如何去配置，这里使用的是 OpenMV 的配置
	 //{0x3a02,0x05},	{0x3a03,0xc4},	 //最大曝光  15:0
	
	 {0x3a02,0xff},	{0x3a03,0xc4},	 //最大曝光  15:0
   {0x3a08,0x00},	{0x3a09,0x93},	{0x3a0a,0x00},
   {0x3a0b,0x7b},	{0x3a0d,0x08}, {0x3a0e,0x06},	
   //{0x3a14,0x05},	{0x3a15,0xc4},
   {0x3a14,0xff},	{0x3a15,0xc4},
...
// 不清楚要如何去配置，这里直接使用 OV5640应用指南 里的设置
	...
	//{0x5580,0x1e}, {0x5583,0x80},	{0x5584,0x80}, {0x5589, 0x08},
	//{0x1e, 0x80, 0x80, 0x08}, /* +2 黑白模式*/
...
// 不清楚要如何去配置，这里直接使用 OV5640应用指南 里的设置，手册里还给出了好几种曝光设置
	...
	{0x3a0f,0x60}, {0x3a10,0x58},	{0x3a1b,0xa0}, {0x3a1e,0x60}, {0x3a11,0x58}, {0x3a1f,0x20},  //曝光补偿+3
