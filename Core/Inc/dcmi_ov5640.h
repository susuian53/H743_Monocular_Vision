...
#define		CAM_LED_OFF		HAL_GPIO_WritePin(GPIOE, GPIO_PIN_12, GPIO_PIN_RESET);	// 低电平，关闭摄像头补光LED
#define 	CAM_LED_ON		HAL_GPIO_WritePin(GPIOE, GPIO_PIN_12, GPIO_PIN_SET);	// 高电平，开启摄像头补光LED
